...
if (empty($user_course)) die(2);

$passing_grade = get_post_meta($course_id, 'passing_grade', true);
$passing_grade = intval($passing_grade);
$passing_grade = (!empty($passing_grade)) ? $passing_grade : '20';

$user_course = STM_LMS_Helpers::simplify_db_array($user_course);

if ($user_course['progress_percent'] < $passing_grade) die();
