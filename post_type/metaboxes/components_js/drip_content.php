<script>
    <?php
    ob_start();
    include STM_LMS_PATH . '/post_type/metaboxes/components/drip_content.php';
    ...
    Vue.component('stm-autocomplete-drip-content', {
        ...
        methods: {
            ...
            onSearch(search) {
                ...
                _this.getPosts(stm_lms_ajaxurl + '?action=stm_curriculum&nonce='+ stm_lms_nonces['stm_curriculum'] + '&s=' + search + '&post_types=' + post_types, 'options');
            },
